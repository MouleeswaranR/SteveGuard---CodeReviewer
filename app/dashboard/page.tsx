...
const MainPage = () => {
  ...
  return (
    ...
    <div>
       ...
       <p className='text-muted-foreground'>Overview of you Activity on Github and AI Reviews</p>
    </div>
    <div className='grid gap-4 md:grid-cols-4'>
    <Card>
      <CardHeader className='flex flex-row items-center-safe justify-between space-y-0 pb-2'>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Viaualizing your coding frequency over the last year</CardDescription>
      </CardHeader>
      <CardContent>
        <ContributionGraph/>
      </CardContent>
              ...
              <div className='h-80 w-full'>
                <ResponsiveContainer width={"100%"} height={"100%"}>
                  <BarChart data={monthlyActivity||[]}>
                    ...
                    <Bar dataKey="reviews" name="AI Reviews" fill="#10b891" radius={[4,4,0,0]}/>
                  </BarChart >
                </ResponsiveContainer>
              </div>
            )

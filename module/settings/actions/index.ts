...
export async function updateUserProfile(data:{name?:string;email?:string}){
    ...
    return {
        ...
        console.error("Error updaing user profile:",error);
...
export async function disconnectRepository(repoId:string){
    ...
    return {success:true}
        ...
        return {success:false,error:"Failed to disconnect respository"}     
    }
}
...
export async function disconnectAllRepository(){
    ...
    return {success:true,count:result.count}
        ...
        return {success:false,error:"Failed to disconnect all respositories"}     
    }
}